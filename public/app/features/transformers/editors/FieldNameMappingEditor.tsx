...
import { type FieldNameMappingTransformerOptions } from '@grafana/data/internal';
...
export const getFieldNameMappingRegistryItem: () => TransformerRegistryItem<FieldNameMappingTransformerOptions> =
  () => ({
